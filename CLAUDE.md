...
WhatsApp agent "Leonardo" for Castro Veículos (used-car dealer, Taubaté/SP) on top of GoHighLevel (GHL). Single-tenant, PIT auth. Portuguese (pt-BR), persona rules in §2 are strict — banned phrases list matters.
